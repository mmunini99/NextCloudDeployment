...
# Broadcast One Node Benchmark
echo "Starting Broadcast One Node Benchmark..."

# Create k8s namespace 
kubectl create namespace osu

export OUTPUT=bcast-one-node-results.txt
echo "Broadcast One Node Benchmark Results" > $OUTPUT
echo "====================================" >> $OUTPUT
...
while [ "$STATUS" != "Completed" ]; do
    ...
    echo "Running Broadcast One Node benchmark... | Status: $STATUS"
    sleep 5
done
...
kubectl delete mpijob bcast-one-node --namespace osu
kubectl delete namespace osu

echo "Broadcast One Node benchmark completed successfully!"
