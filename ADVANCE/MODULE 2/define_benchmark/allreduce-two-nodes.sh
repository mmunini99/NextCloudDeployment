...
# AllReduce Two Nodes Benchmark
echo "Starting AllReduce Two Nodes Benchmark..."

# Create k8s namespace 
kubectl create namespace osu

export OUTPUT=allreduce-two-nodes-results.txt
echo "AllReduce Two Nodes Benchmark Results" > $OUTPUT
echo "=====================================" >> $OUTPUT
...
while [ "$STATUS" != "Completed" ]; do
    ...
    echo "Running AllReduce Two Nodes benchmark... | Status: $STATUS"
    sleep 5
done
...
kubectl delete mpijob allreduce-two-nodes --namespace osu
kubectl delete namespace osu

echo "AllReduce Two Nodes benchmark completed successfully!"
