...
# AllReduce One Node Benchmark
echo "Starting AllReduce One Node Benchmark..."

# Create k8s namespace 
kubectl create namespace osu

export OUTPUT=allreduce-one-node-results.txt
echo "AllReduce One Node Benchmark Results" > $OUTPUT
echo "====================================" >> $OUTPUT
...
while [ "$STATUS" != "Completed" ]; do
    ...
    echo "Running AllReduce One Node benchmark... | Status: $STATUS"
    sleep 5
done
...
kubectl delete mpijob allreduce-one-node --namespace osu
kubectl delete namespace osu

echo "AllReduce One Node benchmark completed successfully!"
